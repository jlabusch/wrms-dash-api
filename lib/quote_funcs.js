...
function is_sla_quote_for_this_period(row, context){
    let q = describe_quote(row);
    return  q.sla &&
            q.period === context.period;
}

function is_additional_quote_for_this_period(row, context){
    let q = describe_quote(row);
    return  q.additional &&
...
function quote_sql(context, approved){
...
function make_query_handler(pred, transform){
...
module.exports = {
    describe_quote: describe_quote,
    exclude_additional_quote_statuses: ['F', 'H', 'M'],
    is_sla_quote_for_this_period: is_sla_quote_for_this_period,
    is_additional_quote_for_this_period: is_additional_quote_for_this_period,
    convert_quote_amount: convert_quote_amount,
    quote_sql: quote_sql,
    make_query_handler: make_query_handler
}
